        ...
        <>
            <div className='mx-auto px-4 pt-20'>
                <div className='text-center'>
                    ...
                    <div className='flex justify-center gap-x-7 mb-10'>
            ...
            <div className='relative'>
                ...
                <div className='max-w-screen-2xl mx-auto px-4 absolute top-0 left-0 flex items-center w-full h-full'>
                    <div className='card-location ml-40'>
